...
mavlink.messages.cpu_load.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.batVolt, this.sensLoad, this.ctrlLoad]));
}
...
mavlink.messages.mid_lvl_cmds.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.hCommand, this.uCommand, this.rCommand, this.target]));
}
...
mavlink.messages.ctrl_srfc_pt.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.bitfieldPt, this.target]));
}
...
mavlink.messages.slugs_action.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.actionVal, this.target, this.actionId]));
}
...
mavlink.map = {
        ...
        183: { format: '<HBB', type: mavlink.messages.slugs_action, order_map: [1, 2, 0], crc_extra: 65 },
