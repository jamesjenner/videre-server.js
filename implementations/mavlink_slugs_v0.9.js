...
mavlink.MAVLINK_MSG_ID_AIR_DATA = 171
...
mavlink.MAVLINK_MSG_ID_SLUGS_ACTION = 183
...
mavlink.messages.cpu_load.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sensLoad, this.ctrlLoad, this.batVolt]));
}
...
*/
mavlink.messages.air_data = function(dynamicPressure, staticPressure, temperature) {

    this.format = '>ffH';
    this.id = mavlink.MAVLINK_MSG_ID_AIR_DATA;
    this.order_map = [0, 1, 2];
    this.crc_extra = 232;
    this.name = 'AIR_DATA';

    this.fieldnames = ['dynamicPressure', 'staticPressure', 'temperature'];
...
mavlink.messages.air_data.prototype = new mavlink.message;

mavlink.messages.air_data.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.dynamicPressure, this.staticPressure, this.temperature]));
}
...
mavlink.messages.sensor_bias.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.axBias, this.ayBias, this.azBias, this.gxBias, this.gyBias, this.gzBias]));
}
...
mavlink.messages.diagnostic.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.diagFl1, this.diagFl2, this.diagFl3, this.diagSh1, this.diagSh2, this.diagSh3]));
}
...
*/
mavlink.messages.slugs_navigation = function(u_m, phi_c, theta_c, psiDot_c, ay_body, totalDist, dist2Go, fromWP, toWP) {

    this.format = '>fffffffBB';
    this.id = mavlink.MAVLINK_MSG_ID_SLUGS_NAVIGATION;
    this.order_map = [0, 1, 2, 3, 4, 5, 6, 7, 8];
    this.crc_extra = 120;
    this.name = 'SLUGS_NAVIGATION';

    this.fieldnames = ['u_m', 'phi_c', 'theta_c', 'psiDot_c', 'ay_body', 'totalDist', 'dist2Go', 'fromWP', 'toWP'];
...
mavlink.messages.slugs_navigation.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.u_m, this.phi_c, this.theta_c, this.psiDot_c, this.ay_body, this.totalDist, this.dist2Go, this.fromWP, this.toWP]));
}
...
mavlink.messages.data_log.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.fl_1, this.fl_2, this.fl_3, this.fl_4, this.fl_5, this.fl_6]));
}
...
*/
mavlink.messages.gps_date_time = function(year, month, day, hour, min, sec, visSat) {
    ...
    this.fieldnames = ['year', 'month', 'day', 'hour', 'min', 'sec', 'visSat'];
...
mavlink.messages.gps_date_time.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.year, this.month, this.day, this.hour, this.min, this.sec, this.visSat]));
}

/* 
Mid Level commands sent from the GS to the autopilot. These are only
sent when being opperated in mid-level commands mode from the ground;
for periodic report of these commands generated from the autopilot see
message XXXX.
...
mavlink.messages.mid_lvl_cmds.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.target, this.hCommand, this.uCommand, this.rCommand]));
}

/* 
This message configures the Selective Passthrough mode. it allows to
select which control surfaces the Pilot can control from his console.
It is implemented as a bitfield as follows:              Position
Bit        Code             =================================
15-8             Reserved               7                 dt_pass
128             6                 dla_pass   64             5
dra_pass   32             4                 dr_pass    16
3                 dle_pass   8             2                 dre_pass
4             1                 dlf_pass   2             0
drf_pass   1             Where Bit 15 is the MSb. 0 = AP has control
of the surface; 1 = Pilot Console has control of the surface.
...
mavlink.messages.ctrl_srfc_pt.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.target, this.bitfieldPt]));
}
...
*/
mavlink.messages.slugs_action = function(target, actionId, actionVal) {

    this.format = '>BBH';
    this.id = mavlink.MAVLINK_MSG_ID_SLUGS_ACTION;
    this.order_map = [0, 1, 2];
    this.crc_extra = 202;
    this.name = 'SLUGS_ACTION';

    this.fieldnames = ['target', 'actionId', 'actionVal'];
...
mavlink.messages.slugs_action.prototype = new mavlink.message;

mavlink.messages.slugs_action.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.target, this.actionId, this.actionVal]));
}
...
mavlink.map = {
        170: { format: '>BBH', type: mavlink.messages.cpu_load, order_map: [0, 1, 2], crc_extra: 150 },
        171: { format: '>ffH', type: mavlink.messages.air_data, order_map: [0, 1, 2], crc_extra: 232 },
        ...
        176: { format: '>fffffffBB', type: mavlink.messages.slugs_navigation, order_map: [0, 1, 2, 3, 4, 5, 6, 7, 8], crc_extra: 120 },
        177: { format: '>ffffff', type: mavlink.messages.data_log, order_map: [0, 1, 2, 3, 4, 5], crc_extra: 167 },
        179: { format: '>BBBBBBB', type: mavlink.messages.gps_date_time, order_map: [0, 1, 2, 3, 4, 5, 6], crc_extra: 16 },
        180: { format: '>Bfff', type: mavlink.messages.mid_lvl_cmds, order_map: [0, 1, 2, 3], crc_extra: 2 },
        181: { format: '>BH', type: mavlink.messages.ctrl_srfc_pt, order_map: [0, 1], crc_extra: 52 },
        183: { format: '>BBH', type: mavlink.messages.slugs_action, order_map: [0, 1, 2], crc_extra: 202 },
