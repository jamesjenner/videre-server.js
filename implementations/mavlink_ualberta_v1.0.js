...
mavlink.messages.nav_filter_bias.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.accel_0, this.accel_1, this.accel_2, this.gyro_0, this.gyro_1, this.gyro_2]));
}
...
mavlink.messages.radio_calibration.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.aileron, this.elevator, this.rudder, this.gyro, this.pitch, this.throttle]));
}
...
mavlink.messages.ualberta_sys_status.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.mode, this.nav_mode, this.pilot]));
}
...
mavlink.map = {
        220: { format: '<dffffff', type: mavlink.messages.nav_filter_bias, order_map: [0, 1, 2, 3, 4, 5, 6], crc_extra: 34 },
