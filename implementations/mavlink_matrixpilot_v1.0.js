...
mavlink.messages.flexifunction_set.prototype.pack = function() {
...
mavlink.messages.flexifunction_read_req.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.read_req_type, this.data_index, this.target_system, this.target_component]));
}
...
mavlink.messages.flexifunction_buffer_function.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.func_index, this.func_count, this.data_address, this.data_size, this.target_system, this.target_component, this.data]));
}
...
mavlink.messages.flexifunction_buffer_function_ack.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.func_index, this.result, this.target_system, this.target_component]));
}
...
mavlink.messages.flexifunction_directory.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component, this.directory_type, this.start_index, this.count, this.directory_data]));
}
...
mavlink.messages.flexifunction_directory_ack.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.result, this.target_system, this.target_component, this.directory_type, this.start_index, this.count]));
}
...
mavlink.messages.flexifunction_command.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component, this.command_type]));
}
...
mavlink.messages.flexifunction_command_ack.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.command_type, this.result]));
}
...
mavlink.messages.serial_udb_extra_f4.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_ROLL_STABILIZATION_AILERONS, this.sue_ROLL_STABILIZATION_RUDDER, this.sue_PITCH_STABILIZATION, this.sue_YAW_STABILIZATION_RUDDER, this.sue_YAW_STABILIZATION_AILERON, this.sue_AILERON_NAVIGATION, this.sue_RUDDER_NAVIGATION, this.sue_ALTITUDEHOLD_STABILIZED, this.sue_ALTITUDEHOLD_WAYPOINT, this.sue_RACING_MODE]));
}
...
mavlink.messages.serial_udb_extra_f5.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_YAWKP_AILERON, this.sue_YAWKD_AILERON, this.sue_ROLLKP, this.sue_ROLLKD, this.sue_YAW_STABILIZATION_AILERON, this.sue_AILERON_BOOST]));
}
...
mavlink.messages.serial_udb_extra_f6.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_PITCHGAIN, this.sue_PITCHKD, this.sue_RUDDER_ELEV_MIX, this.sue_ROLL_ELEV_MIX, this.sue_ELEVATOR_BOOST]));
}
...
mavlink.messages.serial_udb_extra_f7.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_YAWKP_RUDDER, this.sue_YAWKD_RUDDER, this.sue_ROLLKP_RUDDER, this.sue_ROLLKD_RUDDER, this.sue_RUDDER_BOOST, this.sue_RTL_PITCH_DOWN]));
}
...
mavlink.messages.serial_udb_extra_f8.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_HEIGHT_TARGET_MAX, this.sue_HEIGHT_TARGET_MIN, this.sue_ALT_HOLD_THROTTLE_MIN, this.sue_ALT_HOLD_THROTTLE_MAX, this.sue_ALT_HOLD_PITCH_MIN, this.sue_ALT_HOLD_PITCH_MAX, this.sue_ALT_HOLD_PITCH_HIGH]));
}
...
mavlink.messages.serial_udb_extra_f13.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_lat_origin, this.sue_lon_origin, this.sue_alt_origin, this.sue_week_no]));
}
...
mavlink.messages.serial_udb_extra_f14.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_TRAP_SOURCE, this.sue_RCON, this.sue_TRAP_FLAGS, this.sue_osc_fail_count, this.sue_WIND_ESTIMATION, this.sue_GPS_TYPE, this.sue_DR, this.sue_BOARD_TYPE, this.sue_AIRFRAME, this.sue_CLOCK_CONFIG, this.sue_FLIGHT_PLAN_TYPE]));
}
...
mavlink.messages.serial_udb_extra_f15.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_ID_VEHICLE_MODEL_NAME, this.sue_ID_VEHICLE_REGISTRATION]));
}
...
mavlink.messages.serial_udb_extra_f16.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.sue_ID_LEAD_PILOT, this.sue_ID_DIY_DRONES_URL]));
}
...
mavlink.messages.altitudes.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.alt_gps, this.alt_imu, this.alt_barometric, this.alt_optical_flow, this.alt_range_finder, this.alt_extra]));
}
...
mavlink.messages.airspeeds.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.airspeed_imu, this.airspeed_pitot, this.airspeed_hot_wire, this.airspeed_ultrasonic, this.aoa, this.aoy]));
}
